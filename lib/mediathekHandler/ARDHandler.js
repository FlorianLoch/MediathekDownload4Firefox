	...
	this.getVideoFileURLs = function (sURL, fnCallback) {
		...
		Request({
		  ...
		  onComplete: function (response) {
		  	  ...
		  	  var arURLs = src.match(/http:\/\/mvideos.daserste.de\/videoportal\/[.\S]*mp4/g);
		  	  
		  	  if (arURLs == undefined) {
		  	  	  fnCallback(new Array()); //With the empty array the frontendWorker knows, that no videos have been found
		  	  	  return;
		  	  }
